...
public class ConvenioNuevoPF {
        ...
        public String generarQueryPersonaBeneficiaria(PersonaAltaConvenio personaBeneficiario, String usuario) {
                ...
                queryPersona.agregarParametroValues("NOM_PRIMER_APELLIDO",
                                setValor(personaBeneficiario.getPrimerApellido()));
                queryPersona.agregarParametroValues("NOM_SEGUNDO_APELLIDO",
                                setValor(personaBeneficiario.getSegundoApellido()));
    ...
    public String generarQueryContratante(PersonaAltaConvenio persona, String usuario) throws IOException {
        ...
        public String generarQueryConvenioPf(String nombreVelatorio, String idPromotor, String idVelatorio,
                ...
                querySvtConvenio.agregarParametroValues("IND_TIPO_CONTRATACION", tipoContratacion); // 1.- personas -
                                                                                                    // 0.-
                                                                                                    // empresa
        ...
        public DatosRequest consultarCurpRfc(String curp, String rfc) {
                ...
                if (rfc.equals("\"\"")) {
                        log.info("rfc vacio");
                        SelectQueryUtil query = new SelectQueryUtil();
                        query.select("SP.ID_PERSONA as idPersona", "SP.CVE_RFC AS rfc", "SP.CVE_CURP AS curp",
                                        "SP.CVE_NSS AS nss",
        ...
        public DatosRequest busquedaFolioPersona(String folioConvenio) {
                ...
                querySelect
                                .select("SCP.ID_CONVENIO_PF AS idConvenioPf", "SCP.DES_FOLIO AS folioConvenioPf",
                                                ...
                                                "PROM.NOM_PROMOTOR AS nombrePromotor",
                                                "PROM.NOM_PAPELLIDO AS primerApellidoPromotor",
                                                ...
                                                "SC.CVE_MATRICULA AS cveMatricula", "SC.ID_PERSONA AS idPersona",
                                                "SP.CVE_RFC AS rfc",
                                                "SP.CVE_CURP AS curp", "SP.CVE_NSS AS nss",
                                                "SP.NOM_PERSONA AS nombrePersona",
                                                "SP.NOM_PRIMER_APELLIDO AS primerApellido",
                                                "SP.NOM_SEGUNDO_APELLIDO AS segundoApellido",
                                                "SP.NUM_SEXO AS numSexo", "SP.ID_PAIS AS idPais",
        ...
        public DatosRequest busquedaFolioEmpresa(String folioConvenio) {
                ...
                querySelect.select("SCP.ID_CONVENIO_PF AS idConvenio", "SCP.DES_FOLIO AS desFolio",
                                ...
                                "EMP.REF_NOMBRE AS nombreEmpresa", "EMP.REF_RAZON_SOCIAL AS razonSocial",
                                "EMP.CVE_RFC AS rfc",
                                "EMP.ID_PAIS AS idPais",
                                "EMP.ID_DOMICILIO AS idDomicilio", "SD.REF_CALLE AS calle",
                                ...
                                "EMP.REF_TELEFONO AS telefono", "EMP.REF_CORREO AS correo",
        ...
        public DatosRequest busquedaBeneficiarios(String folioConvenio) {
                ...
                querySelect
                                .select("SP2.ID_PERSONA AS idPersona", "SP2.NOM_PERSONA AS nombreBeneficiario",
                                                ...
                                                "SP2.CVE_RFC AS rfc", "SP2.CVE_CURP AS curp", "SP2.CVE_NSS  AS nss",
                                                ...
                                                "TIMESTAMPDIFF(YEAR, SP2.FEC_NAC , NOW()) AS edad",
        ...
        public DatosRequest busquedaRfcEmpresa(String rfc) {
                ...
                Map<String, Object> parametro = new HashMap<>();
                SelectQueryUtil querySelect = new SelectQueryUtil();
                querySelect.select("EC.REF_NOMBRE AS nombreEmpresa", "EC.REF_RAZON_SOCIAL AS razonSocial",
                                "EC.CVE_RFC AS rfc",
        ...
        public Map<String, Object> generarReporte(PdfDto pdfDto, BusquedaInformacionReporteResponse infoReporte) {
                ...
                datosPdf.put("nombreAfiliado",
                                infoReporte.getNombrePersona() + " " + infoReporte.getPrimerApellido() + " "
        ...
        public DatosRequest busquedaFolioParaReporte(String idConvenio) {
                ...
                querySelect
                                .select("SP.CVE_RFC AS rfc", "SP.CVE_CURP AS curp", "SP.CVE_NSS AS nss",
                                        ...
                                        "(SELECT d.DES_DELEGACION FROM SVC_VELATORIO v JOIN SVC_DELEGACION d ON d.ID_DELEGACION = v.ID_DELEGACION  WHERE v.ID_VELATORIO = SCP.ID_VELATORIO)",
