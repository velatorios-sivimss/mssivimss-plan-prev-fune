...
public class ConvenioNuevoPF {
    ...
    public String generarQueryPersona(PersonaAltaConvenio persona, String usuario) {
        ...
        queryPersona.agregarParametroValues("CVE_RFC",setValor(persona.getRfc()));
        queryPersona.agregarParametroValues("CVE_CURP",setValor(persona.getCurp()));
        queryPersona.agregarParametroValues("CVE_NSS",setValor( persona.getNss()));
        queryPersona.agregarParametroValues("NOM_PERSONA",setValor(persona.getNombre()));
        queryPersona.agregarParametroValues("NOM_PRIMER_APELLIDO",setValor(persona.getPrimerApellido()));
        queryPersona.agregarParametroValues("NOM_SEGUNDO_APELLIDO",setValor(persona.getSegundoApellido()));
        queryPersona.agregarParametroValues("NUM_SEXO",setValor(persona.getSexo()));
        queryPersona.agregarParametroValues("REF_OTRO_SEXO",setValor(persona.getOtroSexo()));
        queryPersona.agregarParametroValues("FEC_NAC",setValor(persona.getFechaNacimiento()));
        queryPersona.agregarParametroValues("ID_PAIS", setValor( persona.getPais()));
        queryPersona.agregarParametroValues("ID_ESTADO",setValor(persona.getEntidadFederativa()));
        queryPersona.agregarParametroValues("REF_TELEFONO",setValor(persona.getTelefono()));
        queryPersona.agregarParametroValues("REF_CORREO", setValor(persona.getCorreoElectronico()));
        queryPersona.agregarParametroValues("TIP_PERSONA",setValor( persona.getTipoPersona()));
        queryPersona.agregarParametroValues("NUM_INE",setValor(persona.getNumIne()));
    ...
    public String generarQueryPersonaBeneficiaria(PersonaAltaConvenio personaBeneficiario, String usuario) {
        final QueryHelper queryPersona = new QueryHelper("INSERT INTO SVC_PERSONA");
        queryPersona.agregarParametroValues("CVE_RFC",setValor( personaBeneficiario.getRfc()));
        queryPersona.agregarParametroValues("CVE_CURP",setValor(personaBeneficiario.getCurp()));
        queryPersona.agregarParametroValues("CVE_NSS", setValor(personaBeneficiario.getNss()));
        queryPersona.agregarParametroValues("NOM_PERSONA",setValor(personaBeneficiario.getNombre()));
        queryPersona.agregarParametroValues("NOM_PRIMER_APELLIDO",setValor(personaBeneficiario.getPrimerApellido()));
        queryPersona.agregarParametroValues("NOM_SEGUNDO_APELLIDO",setValor(personaBeneficiario.getSegundoApellido()));
        queryPersona.agregarParametroValues("FEC_NAC", setValor(personaBeneficiario.getFechaNacimiento()));
        queryPersona.agregarParametroValues("REF_TELEFONO",setValor(personaBeneficiario.getTelefono()));
        queryPersona.agregarParametroValues("REF_CORREO",setValor(personaBeneficiario.getCorreoElectronico()));
        queryPersona.agregarParametroValues("ID_USUARIO_ALTA", "'" + usuario + "'");
        log.info("Query insert Persona beneficiaria: " + queryPersona.obtenerQueryInsertar());
        return queryPersona.obtenerQueryInsertar();
    }

    public String generarQueryDomicilio(String calle, String numExt, String numInt, String cp, String colonia,
            String municipio, String estado, String usuario) {
        final QueryHelper queryDomicilio = new QueryHelper("INSERT INTO SVT_DOMICILIO");
        queryDomicilio.agregarParametroValues("REF_CALLE", setValor(calle));
        queryDomicilio.agregarParametroValues("NUM_EXTERIOR",setValor(numExt));
        queryDomicilio.agregarParametroValues("NUM_INTERIOR", setValor(numInt));
        queryDomicilio.agregarParametroValues("REF_CP",setValor(cp) );
        queryDomicilio.agregarParametroValues("REF_COLONIA",setValor(colonia));
        queryDomicilio.agregarParametroValues("REF_MUNICIPIO",setValor(municipio));
        queryDomicilio.agregarParametroValues("REF_ESTADO",setValor(estado));
    ...
    public String generarQueryContratante(PersonaAltaConvenio persona, String usuario) throws IOException {
        ...
        queryContratante.agregarParametroValues("CVE_MATRICULA", setValor(estado)"'" + persona.getMatricula() + "'");
    ...
    public String generarQueryConvenioPf(String nombreVelatorio, String idPromotor, String idVelatorio, String usuario,
        ...
        querySvtConvenio.agregarParametroValues("DES_FOLIO", "(SELECT CONCAT(SUBSTRING('" + nombreVelatorio
                + "',1,3),'-',LPAD((SELECT COUNT(SP.ID_CONVENIO_PF +1) from SVT_CONVENIO_PF SP),6,'0')))");
        querySvtConvenio.agregarParametroValues("FEC_INICIO", "(select DATE_ADD( CURDATE(), INTERVAL 1 DAY))");
        querySvtConvenio.agregarParametroValues("FEC_VIGENCIA",
        ...
        querySvtConvenio.agregarParametroValues("IND_TIPO_CONTRATACION", tipoContratacion); // 1.- personas - 0.-
                                                                                            // empresa
    ...
    public String generarQueryContratantePaquete(PersonaConvenioRequest persona, String usuario) {
        final QueryHelper queryContratantePaquete = new QueryHelper("INSERT INTO SVT_CONTRA_PAQ_CONVENIO_PF");
        ...
        queryContratantePaquete.agregarParametroValues("IND_ENFERMEDAD_PREXISTENTE",
                "'" + persona.getPersona().getEnfermedadPreexistente() + "'");
        queryContratantePaquete.agregarParametroValues("REF_OTRA_ENFERMEDAD",
                "'" + persona.getPersona().getOtraEnfermedad() + "'");
    ...
    public String generarQueryValidacionDocumentos(PersonaConvenioRequest persona, String usuario) {
        ...
        queryValidaDocumentos.agregarParametroValues("IND_ACTA_NACIMIENTO",
                persona.getPersona().getDocumentacion().getValidaActaNacimientoBeneficiario().toString());
    ...
    public DatosRequest obtenerPaquetes(Integer idVelatorio) {
        ...
        String queryPaqueteServiciosArticulos = selectQueryUtilUnionPaqueteServicio
                .union(selectQueryUtilUnionPaqueteArticulo);
    ...
    public DatosRequest consultarCurpRfc(String curp, String rfc) {
        ...
        if (rfc.equals("\"\"")) {
            log.info("rfc vacio");
            SelectQueryUtil query = new SelectQueryUtil();
            query.select("SP.ID_PERSONA as idPersona", "SP.CVE_RFC AS rfc", "SP.CVE_CURP AS curp", "SP.CVE_NSS AS nss",
                    ...
                    "SP.NUM_SEXO AS sexo", "IFNULL(SP.REF_OTRO_SEXO,'') AS otroSexo", "SP.FEC_NAC AS fechaNacimiento",
                    "SP.ID_PAIS AS idPais", "SP.ID_ESTADO AS idEstado",
                    "SP.REF_TELEFONO AS telefono", "SP.REF_CORREO AS correo", "SP.TIP_PERSONA AS tipoPersona",
        ...
        String consultaElse = busquedaRfcCurp(rfc);
    ...
    public DatosRequest consultarCP(String cp) {
        ...
        Map<String, Object> parametro = new HashMap<>();
        SelectQueryUtil query = new SelectQueryUtil();
        query.select("SC.CVE_CODIGO_POSTAL AS codigoPostal", "SC.REF_COLONIA AS colonia",
                "SC.DES_MNPIO AS municipio", "SC.REF_ESTADO AS estado")
                .from("SVC_CP SC")
    ...
    public DatosRequest busquedaFolioPersona(String folioConvenio) {
        ...
        querySelect
                .select("SCP.ID_CONVENIO_PF AS idConvenioPf", "SCP.DES_FOLIO AS folioConvenioPf",
                        "SCP.ID_VELATORIO AS idVelatorio", "SV.DES_VELATORIO AS nombreVelatorio",
                        "SCP.ID_PROMOTOR AS idPromotor", "PROM.NUM_EMPLEDO AS numeroEmpleado",
                        "PROM.NOM_PROMOTOR AS nombrePromotor", "PROM.NOM_PAPELLIDO AS primerApellidoPromotor",
                        "PROM.NOM_SAPELLIDO AS segundoApellidoPromotor",
                        "CPF.ID_CONTRA_PAQ_CONVENIO_PF AS idContratanteConvenioPf",
                        "CPF.ID_CONTRATANTE AS idContratante",
                        "SC.CVE_MATRICULA AS cveMatricula", "SC.ID_PERSONA AS idPersona", "SP.CVE_RFC AS rfc",
                        "SP.CVE_CURP AS curp", "SP.CVE_NSS AS nss", "SP.NOM_PERSONA AS nombrePersona",
                        "SP.NOM_PRIMER_APELLIDO AS primerApellido", "SP.NOM_SEGUNDO_APELLIDO AS segundoApellido",
                        "SP.NUM_SEXO AS numSexo", "SP.ID_PAIS AS idPais", "SP.ID_ESTADO AS idEstado",
                        "SP.REF_TELEFONO AS telefono", "SP.REF_CORREO AS correo", "SP.TIP_PERSONA AS tipoPersona",
                        "SP.NUM_INE AS numIne",
                        "SP.REF_OTRO_SEXO AS otroSexo",
                        "CPF.ID_PAQUETE AS idPaquete", "PAQ.REF_PAQUETE_NOMBRE AS nombrePaquete",
                        "DATE_FORMAT(SP.FEC_NAC,'%Y-%m-%d') AS fechaNacimiento",
                        "SD.REF_CALLE AS calle", "SD.NUM_EXTERIOR AS numExterior", "SD.NUM_INTERIOR AS numInterior",
                        "SD.REF_CP AS cp", "SD.REF_COLONIA AS colonia",
                        "SD.REF_MUNICIPIO AS municipio", "SD.REF_ESTADO AS estado",
                        "CPF.IND_ENFERMEDAD_PREXISTENTE AS idEnfermedadPreexistente",
                        "CPF.REF_OTRA_ENFERMEDAD AS otraEnfermedad")
                ...
                .leftJoin("SVC_PERSONA SP", "SC.ID_PERSONA = SP.ID_PERSONA")
                .leftJoin("SVT_DOMICILIO SD", " SC.ID_DOMICILIO = SD.ID_DOMICILIO")
                .leftJoin("SVT_CONTRATANTE_BENEFICIARIOS SCB",
                        "CPF.ID_CONTRA_PAQ_CONVENIO_PF = SCB.ID_CONTRA_PAQ_CONVENIO_PF")
    ...
    public DatosRequest busquedaFolioEmpresa(String folioConvenio) {
        ...
        Map<String, Object> parametro = new HashMap<>();
        SelectQueryUtil querySelect = new SelectQueryUtil();
        querySelect.select("SCP.ID_CONVENIO_PF AS idConvenio", "SCP.DES_FOLIO AS desFolio",
                "EMP.ID_EMPRESA_CONVENIO_PF AS idEmpresa",
                "EMP.REF_NOMBRE AS nombreEmpresa", "EMP.REF_RAZON_SOCIAL AS razonSocial", "EMP.CVE_RFC AS rfc",
                "EMP.ID_PAIS AS idPais",
                "EMP.ID_DOMICILIO AS idDomicilio", "SD.REF_CALLE AS calle", "SD.NUM_EXTERIOR AS numExterior",
                "IFNULL(SD.NUM_INTERIOR,'') AS numInterior",
                "SD.REF_CP AS cp", "SD.REF_COLONIA AS desColonia", "SD.REF_MUNICIPIO AS desMunicipio",
                "SD.REF_ESTADO AS desEstado",
                "EMP.REF_TELEFONO AS telefono", "EMP.REF_CORREO AS correo", "IFNULL(SCP.ID_PROMOTOR,'') AS idPromotor",
    ...
    public DatosRequest busquedaBeneficiarios(String folioConvenio) {
        ...
        SelectQueryUtil querySelect = new SelectQueryUtil();
        querySelect
                .select("SP2.ID_PERSONA AS idPersona", "SP2.NOM_PERSONA AS nombreBeneficiario",
                        "SP2.NOM_PRIMER_APELLIDO AS primerApellido",
                        "SP2.NOM_SEGUNDO_APELLIDO AS segundoApellido",
                        "DATE_FORMAT(SP2.FEC_NAC,'%Y-%m-%d') AS fechaNacimiento",
                        "SP2.CVE_RFC AS rfc", "SP2.CVE_CURP AS curp", "SP2.CVE_NSS  AS nss", "SP2.NUM_SEXO AS numSexo",
                        "SP2.REF_OTRO_SEXO AS otroSexo", "SP2.NUM_SEXO AS numSexo", "SP2.ID_ESTADO AS idEstado",
                        "SP2.ID_ESTADO as idEstado", "E.REF_ESTADO AS desEstado",
                        "SP2.REF_TELEFONO AS telefono", "SP2.REF_CORREO AS correo", "SP2.TIP_PERSONA AS tipoPersona",
                        "SP2.NUM_INE AS numIne", "TIMESTAMPDIFF(YEAR, SP2.FEC_NAC , NOW()) AS edad",
                        "SCB.IND_INE_BENEFICIARIO AS validaIneBeneficiario",
                        "SCB.IND_ACTA_NACIMIENTO AS validaActaNacimientoBeneficiario",
                        "SCB.ID_PARENTESCO  AS idParentesco", "SCB.CVE_ACTA as cveActa",
    ...
    public DatosRequest busquedaRfcEmpresa(String rfc) {
        ...
        Map<String, Object> parametro = new HashMap<>();
        SelectQueryUtil querySelect = new SelectQueryUtil();
        querySelect.select("EC.REF_NOMBRE AS nombreEmpresa", "EC.REF_RAZON_SOCIAL AS razonSocial", "EC.CVE_RFC AS rfc",
                ...
                "SD.NUM_INTERIOR AS numInterior", "SD.REF_CP AS cp", "SD.REF_COLONIA AS desColonia",
                "SD.REF_MUNICIPIO AS desMunicipio",
    ...
    public Map<String, Object> generarReporte(PdfDto pdfDto, BusquedaInformacionReporteResponse infoReporte) {
        ...
        datosPdf.put("nombreAfiliado", infoReporte.getNombrePersona() + " " + infoReporte.getPrimerApellido() + " "
                + infoReporte.getSegundoApellido());
        ...
        datosPdf.put("nombreTitular", infoReporte.getNombrePersona() + " " + infoReporte.getPrimerApellido() + " "
                + infoReporte.getSegundoApellido());
